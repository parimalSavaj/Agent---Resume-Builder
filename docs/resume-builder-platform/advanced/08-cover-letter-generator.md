# Feature 8: Dynamic Cover Letter Generator
...
- Lets the person edit the generated letter and export it in the same file formats as the resume.
...
3. WHEN a cover letter is generated, THE SYSTEM SHALL allow manual editing and export in the same formats as the resume.
...
- [ ] Reuse the export step from the resume feature for cover letter output
