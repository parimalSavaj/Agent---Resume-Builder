...
export class UpdateEducationRequestDto {
  ...
  static fromRequest(req: Request): UpdateEducationRequestDto {
...
export class UpdateEducationResponseDto {
  readonly id: string;
  readonly institution: string;
  readonly degree: string | null;
  readonly fieldOfStudy: string | null;
  ...
  }): UpdateEducationResponseDto {
    return new UpdateEducationResponseDto({
      id: row.id,
